<div class="container-fluid">
    <div class="card">
        <div class="card-body">
            ...
            <?= form_open_multipart('admin/tambah-produk') ?>
                <div class="row mb-3">
                    <div class="col-4 col-md-4">
                        <div class="mb-3">
                            <img src="" alt="Preview" id="imagePreview" class="img-fluid rounded" style="display:none;">
                        </div>
                ...
                <div class="row mb-3">
                    <div class="col-6 col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="tebal_daun_pintu" id="tebal_daun_pintu"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="tebal_plat_daun_pintu"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="overlap_bibir_pintu"
                    ...
                    <div class="col-6 col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="tebal_rangka_pintu" id="tebal_rangka_pintu"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="tebal_frame_kisi" id="tebal_frame_kisi"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="tebal_plat_kusen_pintu"
                ...
                <div class="row">
                    <div class="col-6 col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="insulation" id="insulation"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="engsel" id="engsel" placeholder="Engsel" />
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="int">Fire Rated
                                <?php echo form_error('fire_rated') ?>
                            </label>
                            <input type="text" class="form-control" name="fire_rated" id="fire_rated"
                    ...
                    <div class="col-6 col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="sliding_gear" id="sliding_gear"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" rows="3" name="aksesoris" id="aksesoris"
                                placeholder="Aksesoris"></textarea>
                        </div>
                    </div>
                </div>
                <hr>
